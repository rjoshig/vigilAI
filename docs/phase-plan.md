...
| 6.10 | Meaning — samples scoped per programme, a mapping interview that proposes requirement → config → report links for an administrator to confirm into shadow rules; edit and typed delete everywhere | 1–2 weeks | 🟡 **in progress** — Part A done | [phase-6.10.md](phase-6.10.md) |
