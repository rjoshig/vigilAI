...
| 6.19 | Say what helps, and teach it in the product — a marker on every field that reaches the model or decides what it is shown, and a Guide in each app's sidebar written for the person in front of it | days | ⬜ **not started** | [phase-6.19.md](phase-6.19.md) |
