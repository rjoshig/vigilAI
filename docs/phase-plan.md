...
| 6.11 | Nothing slips — coverage of every requirement (checked, traced but unchecked, untraced, manual), a fail-closed finalize gate with an attestation, decision reasons and the bulk-OK fix, three independent lenses at stage 8 merged by code, a benchmark harness with precision and recall per finding type | 2–3 weeks | ⬜ **not started** — specified 2026-09-20 | [phase-6.11.md](phase-6.11.md) |
