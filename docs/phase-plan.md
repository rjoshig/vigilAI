...
| 6.8 | Compliance and checks scoped to a programme; validation guides mapping a report cell to the OSL and the configuration with examples; the last ten versions of every definition, with revert | 2 weeks | ⬜ **not started** — proposed, questions open | [phase-6.8.md](phase-6.8.md) |
