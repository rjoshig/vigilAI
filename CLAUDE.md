...
| 6.15 | A compliance rule should survive being spelled differently: option C built (deterministic widening), option A next (the model as a locator) | `docs/phase-6.15.md` | 🟡 in progress |
