...
| 6.12 | One front door: an administrator says what to check in their own words and the model drafts it onto the surface that already runs it; one scope vocabulary everywhere | `docs/phase-6.12.md` | 🟡 in progress |
