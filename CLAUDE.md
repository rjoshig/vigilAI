...
| 6.8 | Scoped compliance, validation guides (report cell ↔ OSL ↔ config, with examples), ten versions of every definition with revert | `docs/phase-6.8.md` | ⬜ not started — proposed and decided |
