...
| 6.11 | Nothing slips: coverage of every requirement, a fail-closed finalize gate with an attestation, decision reasons, three independent lenses at stage 8 merged by code, a benchmark harness with precision and recall | `docs/phase-6.11.md` | 🟡 in progress — a and c–h complete; b deferred |
