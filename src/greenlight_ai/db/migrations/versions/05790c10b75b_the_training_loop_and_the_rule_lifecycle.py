...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("decided_at", greenlight_ai.db.types.Utc(timezone=True), nullable=True),
        sa.Column("created_at", greenlight_ai.db.types.Utc(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("at", greenlight_ai.db.types.Utc(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("candidate_id", sa.Integer(), nullable=True),
        sa.Column("synthesized_at", greenlight_ai.db.types.Utc(timezone=True), nullable=True),
