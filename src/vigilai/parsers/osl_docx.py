...
Implements :class:`vigilai.parsers.base.OslParser` (ADR-006). The OSL is the source of
...
from vigilai.parsers.base import OslDocument, OslSection, OslTable, ParseError
