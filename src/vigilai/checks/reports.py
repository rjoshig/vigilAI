...
All of it is code (ADR-001). The derived checks in :mod:`vigilai.rules.derive` say what
...
from vigilai.checks.named_values import to_number
from vigilai.parsers.base import ReportDocument, ReportKind
from vigilai.rules.derive import DerivedCheck
from vigilai.rules.normalize import AliasTable, normalize_field_name
