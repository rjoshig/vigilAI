...
Every comparison in the product happens here or in :mod:`vigilai.checks`: sets,
...
from vigilai.rules.schema import SET_TYPES, Condition, ConfigElement, Evidence, Finding, Rule
