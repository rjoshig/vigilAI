...
from vigilai.api.deps import CurrentUser, get_auth_settings, get_session, require_admin
from vigilai.api.schemas_auth import ResetPasswordIn, UserIn, UserOut
from vigilai.auth import accounts
from vigilai.auth.passwords import PasswordTooShort, hash_password
from vigilai.auth.sessions import revoke_all_for_user
...
def reset_password(
    ...
    try:
        ...
        from vigilai.auth.passwords import check_length
