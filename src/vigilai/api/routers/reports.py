...
from vigilai.report.pdf import PdfUnavailable, render_pdf, renderer_available
from vigilai.report.render import render_report, write_report
...
def get_report_pdf(
    ...
    return FileResponse(
        ...
        filename=f"vigilai-run-{run_id}.pdf",
    )
